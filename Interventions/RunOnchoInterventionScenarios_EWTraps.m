function [mfPrevIntv,MBRIntv,L3Intv,pIntv,wIntv,MfInt,CTr] = RunOnchoInterventionScenarios_EWTraps(k,...
    ParameterVectors,L3Values,demoX,ageMthMax,da,bCulex,...
    AgeLimits,drugCoverage,VillageDrugEfficacy,...
    MDAInterval,NumYears,MultiVecMBR,VC0,slash_t,TBR,P,R)
...
parfor i = 1:length(k)
    ...
    % treatments
    [VH,Cr] = Temporal_Change_in_VoverH_due_to_VC_EWTraps(VC0,...
