function [mfPrevIntv,MBRIntv,L3Intv,pIntv,wIntv,MonthsMDA,MonthlyMDACov,MfInt,CTr] = Oncho_Intervention_MDA_VC(...
...
[mfPrevIntv,MBRIntv,L3Intv,pIntv,wIntv,MfInt,CTr] = RunOnchoInterventionScenarios_EWTraps(k,...
    ParameterVectors,L3Values,demog,ageMthMax,da,bCulex,...
    AgeLimits,MonthlyMDACov,RegimenEfficacy,...
    MDAInterval,NumYears,MultiVecMBR,VC,slash_t,TBR,P,R);
