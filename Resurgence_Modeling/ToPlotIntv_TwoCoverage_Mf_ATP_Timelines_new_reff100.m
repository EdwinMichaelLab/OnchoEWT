...
refstr="100";
ewtscheme=3;%[1,2,3];
filename="VCEWTsceheme"+ewtscheme+"_CTr_"+CTrstr(1)+"_"+mdastr+"MDA_"+"reff"+refstr+"_eta_"+etastr+"_Jan2024.png";
customPosition = [0 0 .4 .7];
...
%                  int2str(i)));
        load(sprintf('../IO/OUT/reff100/Intv%s_v%s_reff%s_CTr_%s_%sMDAnewparam_ABRth_newtest_eta_%s.mat',char(Sites{iSites}),...
            int2str(i),refstr,CTrstr(1),mdastr,etastr));
        ...
        t = prctile(timeX,50);
        line([t t],[0 ymax*1.1],'LineStyle','-','Color','r','LineWidth',1);
        set(gca,'YLim',[0 ymax]);
        ylabel('ATP','FontSize',10);
...
%         set(gca,'XLim',[1 t1+2],'YLim',[10^-3 10^2],'YTick',[10^-2,10^0,10^2]);
        set(gca,'XLim',[0.5 t+4],'XTick',[1:2:32],'YLim',[10^-2 10^2],'YTick',[10^-2,10^0,10^2],'FontSize',18);
        xlabel('Years','FontSize',14);
        ylabel('Mf prevalence (%)','FontSize',14);
        title(titles{i},'FontSize',10)
        text(0.9,0.95,charlbl{1},'Units','normalized','FontSize',25)
...
%             int2str(i)));
        ...
        line([t t],[10^-3 10^2],'LineStyle','-','Color','b','LineWidth',1);
%         set(gca,'XLim',[1 t1+2],'YLim',[10^-3 10^2],'YTick',[10^-2,10^0,10^2]);
        set(gca,'XLim',[0.5 t+2],'XTick',[1:2:32],'YLim',[10^-2 10^2],'YTick',[10^-2,10^0,10^2],'FontSize',18);
        xlabel('Years','FontSize',14);
        ylabel('Mf prevalence (%)','FontSize',14);
        title(titles{i},'FontSize',10)
        
        text(0.9,0.95,charlbl{2},'Units','normalized','FontSize',25)
        y.LineWidth=2;
