...
titles = {'No S&C','S&C Before Peak Biting Month','S&C During Peak Biting Season','S&C Monthly'};
...
%         set(gca,'XLim',[1 t1+2],'YLim',[10^-3 10^2],'YTick',[10^-2,10^0,10^2]);
        set(gca,'XLim',[0.5 t+2],'XTick',[1:2:20],'YLim',[10^-2 10^2],'YTick',[10^-2,10^0,10^2]);
        xlabel('Years','FontSize',10);
        ylabel('Mf prevalence (%)','FontSize',10);
        title(titles{i+1},'FontSize',10)
    end
