function [mfPrevIntv,MBRIntv,L3Intv,pIntv,wIntv,MonthsMDA,MonthlyMDACov,MfInt,Eff,Lam,CTr] = Oncho_Intervention_MDA_VC(...
            ParameterVectors,L3Values,demog,ageMthMax,bCulex,...
            AgeLimits,MonthlyMDACov,RegimenEfficacy,...
            MDAInterval,NumYears,MultiVecMBR,VC,slash_t,EP_Th,TBR,trapcovereagestr)

da = 1;
k = 1:length(L3Values);

[mfPrevIntv,MBRIntv,L3Intv,pIntv,wIntv,MfInt,Eff,Lam,CTr] = RunOnchoInterventionScenarios_EWTraps(k,...
    ParameterVectors,L3Values,demog,ageMthMax,da,bCulex,...
    AgeLimits,MonthlyMDACov,RegimenEfficacy,...
    MDAInterval,NumYears,MultiVecMBR,VC,slash_t,TBR,trapcovereagestr);
